...
print_pubkey_algo_note( int algo )
{
  if(algo >= 100 && algo <= 110)
	...
	{
	  warn=1;
	  fprintf(stderr, "WARNING: using experimental public key algorithm %s\n",
		   pubkey_algo_to_string(algo));
	}
    }
  else if (algo == 20)
    {
      fprintf(stderr,"WARNING: Elgamal sign+encrypt keys are deprecated\n");
    }
}
...
print_cipher_algo_note( int algo )
{
  if(algo >= 100 && algo <= 110)
	...
	{
	  warn=1;
	  fprintf(stderr,"WARNING: using experimental cipher algorithm %s\n",
...
print_digest_algo_note( int algo )
{
  if(algo >= 100 && algo <= 110)
	...
	{
	  warn=1;
	  fprintf(stderr,"WARNING: using experimental digest algorithm %s\n",
